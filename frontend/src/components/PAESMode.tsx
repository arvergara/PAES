...
export function PAESMode({ subject, onExit, timePerQuestion = 2.16, questionCount = 15 }: PAESModeProps) {
  const { user } = useAuth();
  ...
  if (loading) return <div className="flex items-center justify-center min-h-[400px]"><div className="text-gray-600 dark:text-gray-300">Cargando preguntas...</div></div>;
    ...
    <div className="max-w-4xl mx-auto">
      <div className="flex justify-between items-center mb-8">
        <div className="flex items-center space-x-4">
          ...
          <Timer totalMinutes={totalMinutes} onTimeUp={handleTimeUp} />
        </div>
