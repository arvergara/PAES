...
const modes = [
  {
    ...
    icon: Clock,
    time: '120-160 min',
    questions: '55-80 preguntas',
    badge: 'POPULAR',
    badgeColor: 'bg-amber-200/80 group-hover:bg-amber-300/80 text-amber-800 dark:bg-amber-500/40 dark:group-hover:bg-amber-500/40 dark:text-amber-200',
    ...
    dividerColor: 'border-amber-200 group-hover:border-amber-300 dark:border-amber-500/30 dark:group-hover:border-amber-500/30',
  },
  {
    ...
    badge: 'RECOMENDADO',
    badgeColor: 'bg-emerald-200/80 group-hover:bg-emerald-300/80 text-emerald-800 dark:bg-emerald-500/40 dark:group-hover:bg-emerald-500/40 dark:text-emerald-200',
    ...
    dividerColor: 'border-emerald-200 group-hover:border-emerald-300 dark:border-emerald-500/30 dark:group-hover:border-emerald-500/30',
  },
  {
    ...
    dividerColor: 'border-violet-200 group-hover:border-violet-300 dark:border-violet-500/30 dark:group-hover:border-violet-500/30',
  },
];
      ...
      {modes.map((mode) => {
        ...
        return (
          <button
            ...
            className={`group relative text-left ${mode.bgColor} ${mode.bgHover} rounded-2xl border ${mode.borderColor} shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300 p-6`}
          >
            {/* Badge */}
            {mode.badge && (
